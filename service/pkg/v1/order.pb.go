...
var file_v1_order_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x32, 0xbe, 0x01,
	...
	0x65, 0x1a, 0x09, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x30, 0x01, 0x42, 0x06,
...
var file_v1_order_proto_depIdxs = []int32{
	...
	0, // 4: v1.OrderManagement.getOrder:output_type -> v1.Order
	2, // 5: v1.OrderManagement.addOrder:output_type -> google.protobuf.StringValue
	0, // 6: v1.OrderManagement.searchWithWaffleName:output_type -> v1.Order
